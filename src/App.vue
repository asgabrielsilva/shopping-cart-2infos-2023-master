...
<footer style="color: #fff;" class="bg-black rounded-lg shadow white:bg-white-800">
    <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
      <span class="text-sm text-white-500 sm:text-center white:text-white-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">Guaxinins™</a>. All Rights Reserved.
    </span>
